...
bdb_bytes_per_sector: 		dw 512			; number of bytes per sector
bdb_sectors_per_cluster: 	db 1
bdb_reserved_sectors:		dw 1
bdb_fat_count:				db 2
bdb_dir_entries_count:		dw 0E0h
bdb_total_sectors:			dw 2880			; 512 * 2880 = 1.44 MB
bdb_media_descriptor_type:	db 0F0h			; indicates that this is 3.5" floppy disk
...
lba_to_chs:
    ...
    div word [bdb_sectors_per_track]    ; ax = LBA / SectorsPerTrack
                                        ; dx = LBA % SectorsPerTrack (remainder - остаток)
